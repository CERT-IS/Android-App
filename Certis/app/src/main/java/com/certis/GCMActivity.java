...
import com.certis.gcm.QuickstartPreferences;
import com.certis.gcm.RegistrationIntentService;
import com.google.android.gms.common.ConnectionResult;
import com.google.android.gms.common.GooglePlayServicesUtil;

public class GCMActivity extends NavigationDrawerActivity {
        ...
        mRegistrationBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if(action.equals(QuickstartPreferences.REGISTRATION_READY)){
                    ...
                    edtGCM.setText(token);
                    edtGCM.setVisibility(View.VISIBLE);
                }
...
//        setContentView(R.layout.activity_gcm);
        getLayoutInflater().inflate(R.layout.activity_gcm, main_frame);
        ...
        mInformationTextView.setVisibility(View.GONE);
        edtGCM = (EditText) findViewById(R.id.edtGCM);
        edtGCM.setVisibility(View.GONE);
